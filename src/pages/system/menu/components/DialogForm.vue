        ...
        <t-row :gutter="[20, 20]">
          ...
          <t-col :span="12">
            ...
            <t-form-item label="菜单类型" name="menuType" :rules="[{ required: true, message: '请输入菜单类型' }]">
              <t-radio-group v-model="formData.menuType" style="width: 100%">
          ...
          <t-col :span="12">
            ...
            <t-form-item label="菜单图标" name="icon">
              <t-input v-model="formData.icon" style="width: 100%" clearable placeholder="请输入菜单图标" />
            </t-form-item>
          </t-col>
          ...
          <t-col :span="6">
            ...
            <t-form-item label="菜单名称" name="menuName" :rules="[{ required: true, message: '请输入菜单名称' }]">
              <t-input v-model="formData.menuName" style="width: 100%" clearable placeholder="请输入菜单名称" />
            </t-form-item>
          </t-col>
          <t-col :span="6">
            <!-- 显示顺序 -->
            <t-form-item label="显示顺序" name="orderNum" :rules="[{ required: true, message: '请输入显示顺序' }]">
              <t-input-number v-model="formData.orderNum" style="width: 100%" />
            </t-form-item>
          </t-col>
          <t-col :span="6">
            <!-- 路由地址 -->
            <t-form-item label="路由地址" name="path">
              <t-input v-model="formData.path" style="width: 100%" clearable placeholder="请输入路由地址" />
            </t-form-item>
          </t-col>
          <t-col :span="6">
            <!-- 组件路径 -->
            <t-form-item label="组件路径" name="component">
              <t-input v-model="formData.component" style="width: 100%" clearable placeholder="请输入组件路径" />
            </t-form-item>
          </t-col>
          <t-col :span="6">
            <!-- 路由参数 -->
            <t-form-item label="路由参数" name="queryParam">
              <t-input v-model="formData.queryParam" style="width: 100%" clearable placeholder="请输入路由参数" />
            </t-form-item>
          </t-col>
          <t-col :span="6">
            <!-- 是否为外链 -->
            <t-form-item label="是否为外链" name="isFrame">
              <t-radio-group v-model="formData.isFrame" style="width: 100%">
          ...
          <t-col :span="6">
            ...
            <t-form-item label="是否缓存" name="isCache">
              <t-radio-group v-model="formData.isCache" style="width: 100%">
          ...
          <t-col :span="6">
            ...
            <t-form-item label="显示状态" name="visible">
              <t-radio-group v-model="formData.visible" style="width: 100%">
          ...
          <t-col :span="6">
            ...
            <t-form-item label="菜单状态" name="status">
              <t-radio-group v-model="formData.status" style="width: 100%">
          ...
          <t-col :span="12">
            ...
            <t-form-item label="权限标识" name="perms">
              <t-input v-model="formData.perms" style="width: 100%" clearable placeholder="请输入权限标识" />
            </t-form-item>
          </t-col>
          <t-col :span="12">
            <!-- 备注 -->
